...
javascript :
```html
https://cdn.jsdelivr.net/gh/orestbida/cookieconsent@v2.4.3/dist/cookieconsent.js
```

stylesheet :
```html
https://cdn.jsdelivr.net/gh/orestbida/cookieconsent@v2.4.3/dist/cookieconsent.css
```
