...
javascript :
```html
https://cdn.jsdelivr.net/gh/orestbida/cookieconsent@v2.4.4/dist/cookieconsent.js
```

stylesheet :
```html
https://cdn.jsdelivr.net/gh/orestbida/cookieconsent@v2.4.4/dist/cookieconsent.css
```
