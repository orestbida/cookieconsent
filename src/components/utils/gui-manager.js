 ...
 */
export const _guiManager = function(applyToModal){

    var guiOptions = _state.userConfig['guiOptions'];
    ...
    if(applyToModal===0 && _state.consentModalExists && consentModalOptions){
        _setLayout(
            _dom.consentModal,
            ['box', 'bar', 'cloud'],
            ['top', 'middle', 'bottom'],
