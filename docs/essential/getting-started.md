...
2. Use the CDN hosted version.
    ```
    https://cdn.jsdelivr.net/gh/orestbida/cookieconsent@v3.0.0-rc.1/dist/cookieconsent.umd.js
    https://cdn.jsdelivr.net/gh/orestbida/cookieconsent@v3.0.0-rc.1/dist/cookieconsent.css
    ```
